 ...
 * directly via the DevTools protocol.
 * Use as fallback when globally configured chrome-devtools MCP is unavailable.
 */
...
program
  .name('browser-tools')
  .description('Lightweight Chrome DevTools fallback helpers.')
